...
**[直接下载 UI 交付包（ZIP）](https://github.com/wangyekai918-star/teld-battery-guardian-3-0/releases/latest/download/battery-guardian-ui.zip)**，包含页面源码、资源和接入说明。
...
UI 交付版本：`ui-v1.1.13`。GitHub Pages 从 `main` 根目录发布，无需构建。
